								...
								>
									...
									<tr>
										...
										<td style="width:20%" class="add-img-td">
											<a href="{{ $postUrl }}">
												<img class="img-thumbnail img-fluid" src="{{ data_get($post, 'logo_url') }}" alt="img">
											</a>
										</td>
											...
											<div>
												...
												<p>
													...
													@if (file_exists(public_path($countryFlagPath)))
														<img src="{{ url($countryFlagPath) }}" data-bs-toggle="tooltip" title="{{ data_get($post, 'country.name') }}">
													@endif
												</p>
											</div>
										</td>
										<td style="width:16%" class="price-td">
											<div>
												<strong>
													<?php $postSalaryMin = data_get($post, 'salary_min'); ?>
													@if ($postSalaryMin > 0)
														{!! \App\Helpers\Number::money($postSalaryMin) !!}
													@else
