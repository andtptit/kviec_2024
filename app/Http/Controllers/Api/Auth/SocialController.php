...
class SocialController extends BaseController
{
	 ...
	 */
	public function getProviderTargetUrl($provider): \Illuminate\Http\JsonResponse
	{
	 ...
	 * @return \Illuminate\Http\JsonResponse
	 */
	public function handleProviderCallback($provider): \Illuminate\Http\JsonResponse
	{
		// Get the Provider and verify that if it's supported
		if (!in_array($provider, $this->network)) {
			return $this->respondNotFound();
