...
trait SidebarTrait
{
	 ...
	 */
	public function getSidebar(?array $preSearch = []): array
	{
		$data = [];
		...
		$data['adminsDivisions'] = $this->getAdminsDivisions();
	 ...
	 * @return array
	 */
	private function getAdminsDivisions(): array
	{
