...
class SavedSearchController extends BaseController
{
	 ...
	 * @header Authorization Bearer {YOUR_AUTH_TOKEN}
	 *
	 * @queryParam embed string The Comma-separated list of the category relationships for Eager Loading - Possible values: user,country,postType,category,city,country. Example: null
	 *
