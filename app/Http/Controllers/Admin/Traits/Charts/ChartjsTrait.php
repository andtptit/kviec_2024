...
trait ChartjsTrait
{
	 ...
	 */
	private function getPostsPerCountryForChartjs(int $limit = 10, ?array $colorOptions = [])
	{
		// Init.
	 ...
	 * @return array|mixed|\stdClass
	 */
	private function getUsersPerCountryForChartjs(int $limit = 10, ?array $colorOptions = [])
	{
		// Init.
		$limit = (is_numeric($limit) && $limit > 0) ? $limit : 10;
		$colorOptions = (is_array($colorOptions)) ? $colorOptions : [];
