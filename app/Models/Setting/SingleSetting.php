...
class SingleSetting
{
	...
	public static function getValues($value, $disk)
	{
		if (empty($value)) {
			...
			$value['guests_can_post_listings'] = '0';
			$value['guests_can_contact_authors'] = '0';
			...
			if (!array_key_exists('guests_can_post_listings', $value)) {
				$value['guests_can_post_listings'] = '0';
			}
			if (!array_key_exists('guests_can_contact_authors', $value)) {
				$value['guests_can_contact_authors'] = '0';
			}
